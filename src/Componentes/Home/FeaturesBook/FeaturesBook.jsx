...
const FeaturesBook = () => {
	...
	return (
		<div className='mt-20'>
			<h1 className='text-4xl text-center font-bold'>Features Books</h1>
			...
			<div className='flex flex-wrap items-center justify-center mt-8'>
				...
				>
					{
						books.slice(0, 7).map(book => <SwiperSlide key={book._id}><BookCard book={book}></BookCard></SwiperSlide>)
					}
				</Swiper>
			</div>
		</div>
