...

                            {
                                ...
                                filteredMessages.map(item => (
                                    ...
                                    <div
                                        ...
                                        className="group rounded-[32px] border border-amber-500/15 bg-gradient-to-br from-[#24160f] via-[#1b120d] to-[#15100c] p-8 shadow-[0_20px_60px_rgba(0,0,0,.45)] hover:border-amber-400/40 hover:-translate-y-2 duration-300"
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start justify-between mb-7">
                                            ...
                                            <FaEnvelopeOpenText className="text-4xl text-amber-400" />
                                        ...
                                        <div className="space-y-4 text-slate-300">
...

                                            {
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <FaEnvelopeOpenText className="text-amber-400" />
                                        ...
                                        <div className="mt-7 p-5 rounded-2xl bg-black/20 border border-amber-500/10">
