				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					...
					<div className='flex flex-col gap-2 text-base'>
						...
						<div className="relative">
							<input {...register("publication_date", { required: true })} className='border border-teal-500 bg-transparent px-2 py-1 rounded-xl outline-none w-full' type="date" name='publication_date' />
